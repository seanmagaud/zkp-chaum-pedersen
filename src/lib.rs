...
mod test {
    ...
    fn test_example() {
        ...
        let zkp = ZKP {
            ...
            alpha: alpha.clone(),
            beta: beta.clone(),
        }; // clone is needed because BigUint is not copy
    ...
    fn test_example_with_random_numbers() {
        ...
        let x = BigUint::from(6u32); // secret
        let k = ZKP::generate_random_number_below(&q); // random

        let c = ZKP::generate_random_number_below(&q); // challenge
    ...
    fn test_1024_bits_constants() {
        ...
        let x = ZKP::generate_random_number_below(&q); // secret
        let k = ZKP::generate_random_number_below(&q); // random
